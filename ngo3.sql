...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2024 at 03:15 AM
...
INSERT INTO `donor_history` (`user_id`, `activity_id`) VALUES
(1, '1'),
(1, '1'),
(1, '2');
...
--
ALTER TABLE `donor_history`
  ADD CONSTRAINT `donor_history_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `donor` (`user_id`),
  ADD CONSTRAINT `donor_history_ibfk_2` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`);
